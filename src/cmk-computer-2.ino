...
const uint8_t ROM[ROM_SIZE] PROGMEM = {
  ...
  // hello
  //0x01, 0x00, 0x03, 0x02, 0x04, 0x12, 0x0b, 0x00, 0x0c, 0x04, 0x20, 0x1f, 0xff, 0x0f, 0x09, 0x08, 0x04, 0x03, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x2c, 0x20, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x21, 0x00, 0x08, 0x04, 0x20
  
  // mario walk
  
...
void execute() {
  while (true) { Serial.print(program_counter, HEX);
    ...
    switch (opcode) {
      ...
      case NUM: lcd.print(RAM[read_word()]); break; // TODO: fix address
      ...
      case UDG: {
          ...
          //uint8_t *sprite = (uint8_t*)(program_counter < 0x0400 ? RAM : ROM);
          lcd.createChar(register_A, (uint8_t*)ROM + register_B);
          lcd.begin(16, 2);
          break;
        }
      case SPR: Serial.print("DRAW SPRITE\n"); lcd.write(byte(read_byte(program_counter))); break;
      case DBG:
        lcd.setCursor(0, 0);
